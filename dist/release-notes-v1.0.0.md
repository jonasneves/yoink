...
#### For Users:
1. Download `canvasflow-extension-v1.0.0.zip`
...
Use `canvasflow-extension-v1.0.0.zip` directly in the Developer Dashboard

### Native Host (Optional - for MCP Integration)

**Installation:**
1. Download `canvasflow-native-host-v1.0.0.zip`
